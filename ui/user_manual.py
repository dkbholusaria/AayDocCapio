...
<head>
  ...
  <style>
    *,*::before,*::after{{box-sizing:border-box;margin:0;padding:0;}}
    ...
    .toc{{display:flex;flex-wrap:wrap;gap:10px;justify-content:center;margin-top:28px;max-width:960px;margin-left:auto;margin-right:auto;}}
...
<div class="hero">
  ...
  <div class="toc">
    ...
    <a href="#client-vault">3. Client Vault</a>
    <a href="#bulk-download">4. Bulk Download</a>
    <a href="#form-26as">5. Form 26AS</a>
    <a href="#ais-tis">6. AIS & TIS</a>
    <a href="#pdf-unlock">7. PDF Decryption</a>
    <a href="#import-export">8. Import / Export</a>
    <a href="#tools-menu">9. Tools Menu</a>
    <a href="#mail-docs">10. Mail to Clients</a>
    <a href="#settings-themes">11. Settings & Themes</a>
    <a href="#check-updates">12. Check for Updates</a>
    <a href="#faq-troubleshooting">13. Troubleshooting & FAQ</a>
  </div>
</div>
...
<section class="alt" id="bulk-download">
  <div class="wrap">
...
<section class="alt" id="import-export">
  <div class="wrap">
...
<section class="alt" id="mail-docs">
  <div class="wrap">
...
<section class="alt" id="check-updates">
  <div class="wrap">

      ...
      <div class="wrap">
        ...
        <div id="faq-list" style="scroll-margin-top: 90px; margin-top: 24px;">
          ...
          {section_card(
            ...
            '<p>Open <strong>Help → Report Bug / Request Feature...</strong>. '
            'Choose whether you are reporting a bug or requesting a feature, and the app opens the correct '
            'GitHub form in your browser. Review the form before submitting, and do not include passwords, PANs, '
            'or private taxpayer data.</p>'
            '</details>'
            '<details>'

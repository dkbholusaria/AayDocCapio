...
1. **[requirements.txt](file:///home/deepak/projects/tax-downloader/requirements.txt)**
   Defines all required dependencies (customtkinter, Pillow, pandas, openpyxl, playwright, cryptography, and pyinstaller).

2. **[vault.py](file:///home/deepak/projects/tax-downloader/vault.py)**
...
3. **[automation/browser.py](file:///home/deepak/projects/tax-downloader/automation/browser.py)**
...
4. **[automation/auth.py](file:///home/deepak/projects/tax-downloader/automation/auth.py)**
...
5. **[automation/downloader.py](file:///home/deepak/projects/tax-downloader/automation/downloader.py)**
...
6. **[app.py](file:///home/deepak/projects/tax-downloader/app.py)**
...
7. **[build_win.bat](file:///home/deepak/projects/tax-downloader/build_win.bat)**
...
3. The standalone executable will be saved in `dist/TaxDownloader.exe`.

...
class PreviewWindow(QMainWindow):
    ...
    def _build_hubs(self):
        ...
        ns.add_hub("it", "Income Tax",
                   ...
                   icon="icon_person.png", accent_key="accent_it", section="top", rail_label="INCOME\nTAX")
        ns.add_hub("gst", "GST",
        ...
        ns.add_hub("settings", "Settings",
                   ...
                   icon="menu_appearance.png", accent_key="accent_home", section="bottom", rail_label="SETTINGS")
        ns.add_hub("help", "Help",
                   _placeholder_page("Help", "Real app: User Manual, Email Setup Help, Report Bug, Updates, About."),
                   icon="menu_about.png", accent_key="accent_home", section="bottom", rail_label="HELP")
